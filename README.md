...
- ElephantSQL - Hosting of DRF database
...
3. Run terminal command **django-admin startproject video_games_reviews_api .**
...
13. Create serializers.py file in the video_games_reviews_api directory, and copy UserDetailsSerializer code from Django documentation as follows:
```
...
18. To add a custom message to the root_route, create a views.py file in the video_games_reviews_api directory and add the following code:
...
def root_route(request):
    return Response({
        "message": "Welcome to Video Games Reviews API!"
    })
```
